package com.shunsong.service.system.dictionaries.impl;
...
import com.shunsong.entity.system.Dictionaries;
...
public class DictionariesService implements DictionariesManager{
	 ...
	 */
	@Override
	public List<PageData> findSubDictByBianma(PageData pd) throws Exception{
		return (List<PageData>)dao.findForList("DictionariesMapper.listSubDictByParentBianma", pd);
	}

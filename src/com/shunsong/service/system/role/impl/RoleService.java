package com.shunsong.service.system.role.impl;
...
public class RoleService implements RoleManager{
	 ...
	 */
	@Override
	public PageData findFunctionByRoleId(PageData pd) throws Exception {
		List<PageData> list = (List<PageData>)dao.findForList("RoleMapper.findFunctionByRoleId", pd);

package com.shunsong.service.system.department.impl;
...
import com.shunsong.entity.system.Department;
...
public class DepartmentService implements DepartmentManager{
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PageData> listAllDeptInfo(PageData pd) throws Exception {
		return (List<PageData>) dao.findForList("DepartmentMapper.listDeptByType", pd);
	}

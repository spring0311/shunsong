package com.shunsong.util.mail;
...
/**   
  ...
  */    
     ...
     */
    public static void sendEmail(String toEMAIL, String TITLE, String CONTENT, String TYPE) throws Exception{ 
    	String SMTP = "";
    	String PORT = "";
    	String EMAIL = "";
    	String PAW = "";
        ...
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setContent(CONTENT);
	     if("25".equals(PORT)){
	    	 mailInfo.setOpenSSL("0");
	     }else{
	    	 mailInfo.setOpenSSL("1");
	     }	     
	     //这个类主要来发送邮件   
	     SimpleMailSender sms = new SimpleMailSender();
	    if("1".equals(TYPE)){

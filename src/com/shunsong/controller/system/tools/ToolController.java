package com.shunsong.controller.system.tools;
...
import com.shunsong.util.TwoDimensionCode;
...
public class ToolController extends BaseController {
	...
	public ModelAndView errorInfo() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("error");
		mv.addObject("exception", pd.getString("Exception"));
		return mv;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/RPDTest")
	public ModelAndView RPDTest() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = this.getPageData();
		mv.setViewName("system/tools/RPDTest");
		mv.addObject("pd", pd);
		return mv;
	}
}

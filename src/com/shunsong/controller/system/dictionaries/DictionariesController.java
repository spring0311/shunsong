package com.shunsong.controller.system.dictionaries;
...
public class DictionariesController extends BaseController {
	...
	@RequestMapping(value="/getDictionariesList")
	@ResponseBody
	public Object getDictionariesList()throws Exception{
		Map<String,Object> map = new HashMap<String,Object>();
		PageData pd = new PageData();
		pd = this.getPageData();
		
		List<PageData>	dictionariesList = this.dictionariesService.findSubDictByBianma(pd);
		
		JSONArray jsonArray = JSONArray.fromObject(dictionariesList);
		
		map.put("dictionariesList", jsonArray);

				...
				<div class="row">
					...
					<form action="material/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:200px;text-align: right;padding-top: 13px;">配件名称:</td>
							...
							<tr>
								<td style="width:200px;text-align: right;padding-top: 13px;">模具编号:</td>
								<td><input type="text" name="FILE_NO" id="FILE_NO" value="${pd.FILE_NO}" maxlength="" placeholder="这里输入文件编号" title="文件编号" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:200px;text-align: right;padding-top: 13px;">物料图号:</td>
								<td><input type="text" name="FIGURE_NO" id="FIGURE_NO" value="${pd.FIGURE_NO}" maxlength="" placeholder="这里输入物料图号" title="物料图号" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:200px;text-align: right;padding-top: 13px;">是否用于选择:</td>
								<td><input type="checkbox" name="DROPDOWN_FLAG" id="DROPDOWN_FLAG" value="Y"/></td>
							</tr>
							<tr>

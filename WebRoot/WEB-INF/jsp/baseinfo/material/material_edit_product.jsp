				...
				<div class="row">
					...
					<form action="material/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:200px;text-align: right;padding-top: 13px;">产品分类：</td>
								<td >
									<select class="chosen-select form-control" name="MaterialClassShow" id="MaterialClassShow" data-placeholder="请选择产品分类" style="vertical-align:top;width:98%;" >
										
									</select>	
								</td>
							</tr>
							<tr>
								<td style="width:200px;text-align: right;padding-top: 13px;">产品编号:</td>
								<td><input type="text" name="MATERIAL_CODE" id="MATERIAL_CODE" value="${pd.MATERIAL_CODE}" maxlength="" placeholder="这里输入产品编号" title="物料名称" style="width:98%;"/></td>
							</tr>	
							<tr>
								<td style="width:200px;text-align: right;padding-top: 13px;">产品名称:</td>
								<td><input type="text" name="MATERIAL_NAME" id="MATERIAL_NAME" value="${pd.MATERIAL_NAME}" maxlength="" placeholder="这里输入产品名称" title="物料名称" style="width:98%;"/></td>
							</tr>						
							<tr>
								<td style="width:200px;text-align: right;padding-top: 13px;">产品规格:</td>
								<td><input type="text" name="MATERIAL_SPEC" id="MATERIAL_SPEC" value="${pd.MATERIAL_SPEC}" maxlength="" placeholder="这里输入产品规格" title="文件编号" style="width:98%;"/></td>
							</tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/myjs/materialClassShow.js"></script>
		...
		function save(){
			...
			var machineClassName = $("#MaterialClassShow").val();
			if(typeof(machineClassName)=='undefined' || machineClassName == ""){
				$("#MaterialClassShow").tips({
					side:3,
		            msg:'请选择产品分类',
		            bg:'#AE81FF',
		            time:2
		...
		$(function() {
			...
			showMaterialClassWithSelect("#MaterialClassShow",basePath,'50',classID);

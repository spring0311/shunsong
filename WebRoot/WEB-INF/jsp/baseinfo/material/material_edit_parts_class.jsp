				...
				<div class="row">
					...
					<form action="material/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:200px;text-align: right;padding-top: 13px;">配件分类编号:</td>
								<td><input type="text" name="MATERIAL_CLASS_CODE" id="MATERIAL_CLASS_CODE" value="${pd.MATERIAL_CLASS_CODE}" maxlength="" placeholder="这里输入物料分类编号（可空）" title="物料名称" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:200px;text-align: right;padding-top: 13px;">配件分类名称:</td>
							...
							<tr>
								<td style="width:200px;text-align: right;padding-top: 13px;">毛利率:</td>
								<td>
								 <input type="number" name="GPR_RATE" id="GPR_RATE" value="${pd.GPR_RATE}" maxlength="" placeholder="这里输入设定的毛利率（小于1的数字）" title="物料毛利率" style="width:98%;"/>
								</td>
							</tr>
							<tr>
								<td style="width:200px;text-align: right;padding-top: 13px;">月度统计项目名称:</td>
								<td>
								 <input type="text" name="MONTH_SUM_ITEM" id="MONTH_SUM_ITEM" value="${pd.MONTH_SUM_ITEM}" maxlength="" placeholder="这里输入月度统计项目名称" title="物料毛利率" style="width:98%;"/>
								</td>
							</tr>							
							<tr>

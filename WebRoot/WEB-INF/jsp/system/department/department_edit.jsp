					...
					<form action="department/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td>
									<div class="col-xs-2 label label-lg label-light arrowed-in arrowed-right">
										<b>${null == pds.NAME ?'公司':'公司部门'}</b>
									</div>
									<select class="chosen-select form-control" name="DEPT_FUNC" id="DEPT_FUNC" data-placeholder="请选择部门职能" style="vertical-align:top;width:60%;" >
...
<!-- /.main-container -->
	...
	<!-- 显示物料分类选择 -->
	<script type="text/javascript" src="static/js/myjs/dictionariesShow.js"></script>
		...
		$(function() {
			...
			var classID = '${pd.DEPT_FUNC}';
			
			showDictionariesWithSelect("#DEPT_FUNC",basePath,'DEPTFUNC',"请选择部门职能",classID);

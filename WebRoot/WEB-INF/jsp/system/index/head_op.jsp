		<div id="navbar" class="navbar navbar-default">
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					...
					<!-- <img src="static/login/images/title0201.png" /> -->
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						<li class="red" style="width:200px;">
							...
							<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">								
								<li class="dropdown-header">
									<a onclick="changeShift();" style="cursor:pointer;"><i class="ace-icon fa fa-cog"></i>切换机台</a>
								</li>
							</ul>						
						</li>
						...
						<li class="light-blue">
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li id="productCode">
									<a onclick="productCode();" style="cursor:pointer;"><i class="ace-icon fa fa-user"></i> 代码生成</a>
								</li>
								<li class="divider"></li>
								<li>
									<a href="${logoutUrl}"><i class="ace-icon fa fa-power-off"></i>退出登录</a>
								</li>
							</ul>
						</li>

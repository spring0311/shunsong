<div id="sidebar" class="sidebar                  responsive">
				...
				<c:if test="${menu1.hasMenu && '1' == menu1.MENU_STATE}">
					<li class=""  id="lm${menu1.MENU_ID }">
						<a style="cursor:pointer;" <c:if test="${not empty menu1.MENU_URL && '#' != menu1.MENU_URL}">target="mainFrame" onclick="siMenu('z${menu1.MENU_ID }','lm${menu1.MENU_ID }','${menu1.MENU_NAME }','${menu1.MENU_URL }')"</c:if><c:if test="${'[]' != menu1.subMenu}"> class="dropdown-toggle"</c:if>>
